...
read grid
echo "$grid">grid.txt
./size_core_alloy_shell
echo "Enter the percentage of Au in shell alloy layer"
		read GMF
		echo "$GMF">GMF.txt
		./refractive_index_calculator_core_alloy_shell
./ri_modification_core_alloy_shell
...
./result_core_shell_core_alloy_shell
