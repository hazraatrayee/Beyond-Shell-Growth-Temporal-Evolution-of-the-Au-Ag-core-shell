...
fscanf(fr, "%f", &GMF);
fclose(fr);
sprintf(outputfile_Cext,"Cext_bishell,grid_%d,size_%dangstrom,core dia_%dangstrom,inter_dia_%dangstrom,GMF_%f.txt",grid,size1,size2,size3,GMF);
sprintf(outputfile_Qext,"Qext_bishell,grid_%d,size_%dangstrom,core dia_%dangstrom,inter_dia_%dangstrom,GMF_%f.txt",grid,size1,size2,size3,GMF);
sprintf(outputfile_Cabs,"Cabs_bishell,grid_%d,size_%dangstrom,core dia_%dangstrom,inter_dia_%dangstrom,GMF_%f.txt",grid,size1,size2,size3,GMF);
sprintf(outputfile_Qabs,"Qabs_bishell,grid_%d,size_%dangstrom,core dia_%dangstrom,inter_dia_%dangstrom,GMF_%f.txt",grid,size1,size2,size3,GMF);
...
for(i=0;i<=600;i++)
{
sprintf(filename,"bishell,run_%d,grid_%d,size_%d,core_%d,inter_dia_%d/CrossSec-Y",i,grid,size1,size2,size3);
fp=fopen(filename,"r");
line_no=1;
