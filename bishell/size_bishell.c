...
printf("Enter the outer diameter of the bishell particle in µm\t");
scanf("%f", &size);
printf("\nEnter the core diameter of the bishell particle in µm\t");
scanf("%f", &core_size);
printf("\nEnter the intermediate diameter of bishell particle in µm\t");
scanf("%f",&inter_dia);
s1=size*10000;
size1=(int)s1;
s2=core_size*10000;
