...
static const struct subopt_struct shape_opt[]={
	...
	{"bishell","<d_inter/d> <d_in/d>","Sphere with double outer shell, the outer diameter is d (first domain) "
		"intermediate sphere has a diameter d_inter (second domain) and the core sphere has the diameter d_in "
		"(third domain)",2,SH_BISHELL},
	...
	{"sphericalhollow","<d_in/d>","A spherical hollow shell with outer diameter d(first domain) and hollo core "
		"diameter d_in (void).",1,SH_SPHERICALHOLLOW},
#endif // !SPARSE
